...
import {
  ...
  enableApi,
  disabledApi,
} from '~/api/domainManagement/inspectionWall'
...
export const getFields = ({
  ...
  // },
  {
    ...
    columnConfig: {
      ...
      render: ({ rowData }) =>
        h(
          ElText,
          {},
          (domainMasterData?.masterData?.taskFrequencies?.wallFrequency || []).find(
    ...
    editConfig: {
      ...
      enum: domainMasterData?.masterData?.taskFrequencies?.wallFrequency,
    },
  },
  {
    prop: 'creatorName',
