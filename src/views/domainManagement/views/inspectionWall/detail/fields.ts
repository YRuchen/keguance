...
import { getHistoryNodeListApi } from '~/api/domainManagement/inspectionWall'
import { WallStatus, wallStatusMap, wallStatusOptions } from '~/api/domainManagement/common'
...
export const getFields = (): IField[] => [
  ...
  // startTime和endTime，结果是status，里面有NORMAL和ABNORMAL（正常
  {
    ...
    filterConfig: {
      ...
      default: WallStatus.WALL_STATUS_ALL,
    },
  },
  {
    prop: 'voidTime',
        ...
        ElButton,
        {
          ...
          onClick: async (e: Event) => {
            ...
            formRef.value.values = {
              status: rowData.wallStatus,
              statusCode: rowData.httpStatusCode,
              resolveIp: rowData.resolveIp,
