...
import { getDetailApi } from '~/api/domainManagement/inspectionICP'
import { getFrequencyApi, TaskType, NoticeChannel } from '~/api/domainManagement/common'
  ...
  setup() {
    ...
    const init = async () => {
      try {
        ...
        const res1 = await getFrequencyApi(TaskType.TASK_TYPE_ICP)
